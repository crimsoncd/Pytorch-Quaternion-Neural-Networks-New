...
class QCNNClassifier(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.qconv2 = QuaternionConv(32, 64, kernel_size=3, stride=1, padding=1)
...
def rgb_to_quaternion(t):
    r = torch.zeros_like(t[:, :1])       # real
    return torch.cat([r, t[:, :1], t[:, 1:2], t[:, 2:3]], dim=1)
...
model = QCNNClassifier(num_classes=10).to(device)
